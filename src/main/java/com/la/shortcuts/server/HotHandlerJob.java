...
public class HotHandlerJob extends HttpServlet {

	private static final long serialVersionUID = 1L;
	private static final String QUEUE_NAME = "hotHandlerQueue";
	private static final String QUEUE_URL = "/tasks/hotHandlerQueue";
